...
import bookList from "./booksSciFi";
                ...
                <div className="buttons">
                    <div className="previousCategory">
                        <button className="previousButton one">
                            {/* <Link to="/"><DoubleArrowIcon />{t('Thanks.1')}</Link> */}
                            <Link to="/"><DoubleArrowIcon /> {t('Nav.5')}</Link>
                        </button>
                    </div>
                    ...
                    <div className="nextCategory">
                        <button className="nextButton two">
                            <Link to="/mystery">{t('Nav.2')} <DoubleArrowIcon /></Link>
                        </button>
                    </div>
                </div>
            </div>
